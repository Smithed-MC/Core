...
execute unless score $temp smd.damage matches 1.. run kill @s
execute if score $temp smd.damage matches 1.. store result entity @s Health float 0.01 run scoreboard players get $temp smd.damage
