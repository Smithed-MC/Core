execute unless data storage smd:core item.tag.smithed.durability.dur run function smithed:core/impl/v0_0_2/item/durability/init

function smithed:core/impl/v0_0_2/item/durability/calc_durability
