...
function smithed:core/impl/v0_0_2/entity/damage/armor/toughness

# then protection
function smithed:core/impl/v0_0_2/entity/damage/armor/protection
function smithed:core/impl/v0_0_2/entity/damage/armor/blast_protection

# finally resistance
function smithed:core/impl/v0_0_2/entity/damage/armor/resistance

# go back to same scale
scoreboard players operation @s smd.damage /= 10 smd.const

# apply new damage
execute if score @s smd.damage matches 1.. run function smithed:core/impl/v0_0_2/entity/damage/apply
