...
execute if score @s smithed.damage >= $maximumHealth smithed.damage run function smithed:core/impl/__version__/entity/damage/on_death
execute if score @s smithed.damage < $maximumHealth smithed.damage run function smithed:core/impl/__version__/entity/damage/health/update
