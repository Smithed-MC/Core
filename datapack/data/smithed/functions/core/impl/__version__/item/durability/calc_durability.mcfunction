execute store result score $temp smithed.data run data get storage smithed:core item.tag.smithed.durability.dur
execute store result score $temp1 smithed.data run data get storage smithed:core item.tag.smithed.durability.damage
execute store result score $temp2 smithed.data run data get storage smithed:core item.tag.Damage
execute store result score $temp3 smithed.data run data get storage smithed:core item.tag.smithed.durability.max
function smithed:core/impl/__version__/item/durability/get_max
...
execute if score $temp4 smithed.data matches 1.. store result storage smithed:core item.tag.smithed.durability.dur int 1 run scoreboard players get $temp smithed.data
...
execute if score $temp4 smithed.data matches 1.. store result storage smithed:core item.tag.Damage int 1 run scoreboard players get $temp4 smithed.data
execute if score $temp4 smithed.data matches 1.. store result storage smithed:core item.tag.smithed.durability.damage int 1 run scoreboard players get $temp4 smithed.data

#change durability of unbreakable items
execute if score $temp4 smithed.data matches 0 store result score $temp smithed.data run data get storage smithed:core item.tag.smithed.durability.dur
...
execute if score $temp smithed.data matches ..-1 if data storage smithed:core item.tag.smithed.durability run scoreboard players set $out smithed.data 0
execute if score $temp smithed.data matches ..-1 if data storage smithed:core item.tag.smithed.durability{no_break:1b} run scoreboard players set $out smithed.data -1