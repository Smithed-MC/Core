...
function smithed:core/impl/v0_0_3/entity/damage/armor/toughness

# then protection
function smithed:core/impl/v0_0_3/entity/damage/armor/protection
function smithed:core/impl/v0_0_3/entity/damage/armor/blast_protection

# finally resistance
function smithed:core/impl/v0_0_3/entity/damage/armor/resistance

# go back to same scale
scoreboard players operation @s smithed.damage /= 10 smithed.const

# apply new damage
execute if score @s smithed.damage matches 1.. run function smithed:core/impl/v0_0_3/entity/damage/apply
