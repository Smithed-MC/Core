scoreboard players set 0 smd.const 0
scoreboard players set 1 smd.const 1 
scoreboard players set 2 smd.const 2 
scoreboard players set 3 smd.const 3 
scoreboard players set 4 smd.const 4 
scoreboard players set 5 smd.const 5 
scoreboard players set 6 smd.const 6 
scoreboard players set 7 smd.const 7 
scoreboard players set 9 smd.const 9 
scoreboard players set 10 smd.const 10 
...
scoreboard players set 60 smd.const 60 
scoreboard players set 70 smd.const 70 
