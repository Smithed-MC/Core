execute unless data storage smd:core item.tag.smithed.durability.dur run function smithed:core/item/durability/init

function smithed:core/item/durability/calc_durability
